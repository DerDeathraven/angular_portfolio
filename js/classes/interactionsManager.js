...
export class InteractionsManager{
    ...
    add(variant,object){
        switch(variant){
            ...
            case "mouseleave":
                ...
                break;
            case "leftClick":
                this.leftClickArr = [...this.leftClickArr,object]
                break;
        }
    ...
    fireEvent(action){
        ...
        switch(action){
            ...
            break;
            case "leftClick":
                this.leftClickArr.forEach(e=>{
                    if(e.object.uuid == this.clicked.uuid){
                        console.log("test")
                        e.leftClick()
                        object = e
    ...
    leftClick(){
        ...
        if(this.subscribedUuids.indexOf(intersects[0].object.uuid)!=-1){
            console.log("leftClick")
            this.clicked = intersects[0].object
            this.fireEvent("leftClick") //Fire leftcklick, when object clicked
        }
    }
    ...
    generateSubscribeedUuids(){
        ...
        this.leftClickArr.forEach(searcher)
